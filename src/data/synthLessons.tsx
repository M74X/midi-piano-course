...
export const genreColors: Record<Genre, { bg: string; text: string; border: string }> = {
  darkambient: { bg: 'from-indigo-900 to-black',  text: 'text-indigo-400',  border: 'border-indigo-500' },
